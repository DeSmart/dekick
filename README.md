![version 2.5.3](https://img.shields.io/badge/version-develop-teal.svg) ![Licence MIT](https://img.shields.io/badge/license-MIT-blue.svg)
...
<a id="markdown-how-it-works%3F" name="how-it-works%3F"></a>
 - DeKick uses small script (`dekick-docker.sh`) to run [`desmart/dekick:2.5.3`](https://hub.docker.com/r/desmart/dekick) image that has already installed Python with the proper version as well as Python's packages neccessary to run DeKick.
